...
import com.example.playerbalti.databinding.MenuSortGenresBinding
import com.example.playerbalti.storage.shared
import com.google.android.material.bottomsheet.BottomSheetDialogFragment

class menu_sort_genres_adapter : BottomSheetDialogFragment() {
    lateinit var b: MenuSortGenresBinding
    ...
    override fun onCreateView(
        ...
        b = MenuSortGenresBinding.inflate(inflater,container,false)
        ...
        b.dir.setOnClickListener {
            ...
            if(shared.genres_sort_type=="name-asc"){
                shared.set(requireContext(), "sort", "genres_sort_type","name-desc")
            }else if(shared.genres_sort_type=="name-desc"){
                shared.set(requireContext(), "sort", "genres_sort_type","name-asc")
            }else if(shared.genres_sort_type=="count-asc"){
                shared.set(requireContext(), "sort", "genres_sort_type","count-desc")
            }else if(shared.genres_sort_type=="count-desc"){
                shared.set(requireContext(), "sort", "genres_sort_type","count-asc")
            }
        ...
        b.containerTitle.setOnClickListener{
            //save new sort option:
            if(shared.genres_sort_type=="name-asc" || shared.genres_sort_type=="count-asc") {
                shared.set(requireContext(), "sort", "genres_sort_type","name-asc")
            }else{
                shared.set(requireContext(), "sort", "genres_sort_type","name-desc")
            }
