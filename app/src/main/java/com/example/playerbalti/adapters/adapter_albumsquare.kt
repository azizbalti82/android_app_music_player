...
class AlbumsAdapterS(private var albums:List<album>,private val fragmentManager: FragmentManager) : RecyclerView.Adapter<AlbumsAdapterS.AlbumsViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AlbumsViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_item_albumsquare, parent, false)
    ...
    override fun onBindViewHolder(holder: AlbumsViewHolder, position: Int) {
        ...
        data.loadImage(holder.itemView.context, url, holder.art,R.drawable.album)
         */
